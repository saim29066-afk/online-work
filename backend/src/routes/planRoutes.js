...
const { getPlans, buyPlan, getMyInvestments, claimDailyProfit, claimIndividualPlanProfit } = require('../controllers/planController');
...
router.post('/claim-daily/:id', protect, checkNotRestricted, claimIndividualPlanProfit);
